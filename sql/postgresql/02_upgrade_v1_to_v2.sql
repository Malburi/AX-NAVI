...
-- ---------- 기존 표에 담당자 연결 컬럼 추가 ----------
ALTER TABLE wikihub_systems ADD COLUMN IF NOT EXISTS owner_person_id INTEGER;
ALTER TABLE wikihub_page_versions ADD COLUMN IF NOT EXISTS author_person_id INTEGER;
ALTER TABLE wikihub_publish_log ADD COLUMN IF NOT EXISTS publisher_person_id INTEGER;
